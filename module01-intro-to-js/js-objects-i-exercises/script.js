...
// Without destructuring or saving the result inside a variable (for comparison):
...
// Alternative if you also want to display city
// function displayPerson({ name, age, address: { city } }) {
//   console.log(`Name: ${name}, Age: ${age}, City: ${city}`);
// }
// displayPerson(person);

// Alternative if you also want to display city and zip
...
// Alternative if you only want to display city and zip
