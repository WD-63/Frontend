...
console.log("\ntotalYearsLived: ", totalYearsLived);
...
console.log("\nshortestLifeToLongest: ", shortestLifeToLongest);
...
console.log("\nlongestLifeToShortest: ", longestLifeToShortest);
...
console.log("\nboulevardsWithDe: ", boulevardsWithDe);

// Alternative if you want to filter more strict
...
// Alternative using the startsWith string method

// const allStartWithL = family.every((member) => member.name.startsWith("L"));

console.log("\nallStartWithL: ", allStartWithL);
